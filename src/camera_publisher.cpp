...
public:
        ...
        : Node("camera_publisher")
    {
        ...
        RCLCPP_INFO(this->get_logger(), "KAMERA BAŞLATILDI...");
    }
...
private:
    ...
    {
        bool is_kamikaze = (msg->data == "KAMIKAZE" || msg->data == "kamikaze");
        if (is_kamikaze) kamikaze_mode_ = true;
        else if (!is_kamikaze && kamikaze_mode_) kamikaze_mode_ = false;
    }
